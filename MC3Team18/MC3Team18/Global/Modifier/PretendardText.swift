...
struct PretendardTextBold16: ViewModifier {
    
    func body(content: Content) -> some View {
        content.font(.custom("Pretendard-Bold", size: 16))
    }
}
struct PretendardTextBold14: ViewModifier {
    
    func body(content: Content) -> some View {
        content.font(.custom("Pretendard-Bold", size: 14))
    }
}
...
struct PretendardTextSemiBold28: ViewModifier {
    
    func body(content: Content) -> some View {
        content.font(.custom("Pretendard-SemiBold", size: 28))
    }
}

struct PretendardTextSemiBold24: ViewModifier {
    
    func body(content: Content) -> some View {
        content.font(.custom("Pretendard-SemiBold", size: 24))
    }
}

struct PretendardTextSemiBold20: ViewModifier {
    
    func body(content: Content) -> some View {
        content.font(.custom("Pretendard-SemiBold", size: 20))
    }
}
...
struct PretendardTextSemiBold16: ViewModifier {
    
    func body(content: Content) -> some View {
        content.font(.custom("Pretendard-SemiBold", size: 16))
    }
}
...
struct PretendardTextSemiBold12: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.font(.custom("Pretendard-SemiBold", size: 12))
    }
}

struct PretendardTextLight32: ViewModifier {
    
    func body(content: Content) -> some View {
        content.font(.custom("Pretendard-Light", size: 32))
    }
}

struct PretendardTextLight16: ViewModifier {
    
    func body(content: Content) -> some View {
        content.font(.custom("Pretendard-Light", size: 16))
    }
}
...
struct PretendardTextRegular12: ViewModifier {
...
struct PretendardTextMedium16: ViewModifier {
    
    func body(content: Content) -> some View {
        content.font(.custom("Pretendard-Medium", size: 16))
    }
}
...
struct PretendardExtraLight12: ViewModifier {
    
    func body(content: Content) -> some View {
        content.font(.custom("Pretendard-ExtraLight", size: 12))
    }
}
